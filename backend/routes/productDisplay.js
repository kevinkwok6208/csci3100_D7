...
/*  "http://localhost:5001/api/product-display/get-comments/{productId}"
    "https://localhost:5443/api/product-display/get-comments/{productId}"
    Parameters: req.params.productId
...
/*  "http://localhost:5001/api/product-display/get-ratings/{productId}"
    "https://localhost:5443/api/product-display/get-ratings/{productId}"
    Parameters: req.params.productId
